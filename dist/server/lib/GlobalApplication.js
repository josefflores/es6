...
var _development = require('../../../dist/ini/development');

var _development2 = _interopRequireDefault(_development);

var _production = require('../../../dist/ini/production');

var _production2 = _interopRequireDefault(_production);

var _gulp = require('../../../dist/ini/gulp');
...
/**
 *  The Global application object, ties in configurations, application reporting.
 * 	It is to be imported in the application entry point.
 *
 *  Examples:
 *
...
class GlobalApp {
     ...
     */
	get ini() {
		let mode = _private.get(this).mode;

		if (mode == 'developement') return _development2.default;
		if (mode == 'production') return _gulp2.default;
		if (mode == 'gulp') return _production2.default;
		return undefined;
	}
