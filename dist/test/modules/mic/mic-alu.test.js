...
var _micAlu = require('../../../modules/mic/mic-alu');

var _micAlu2 = _interopRequireDefault(_micAlu);
...
let micAlu = new _micAlu2.default();
...
function test(msg, bits, input, expected, test) {
    ...
    it(msg, () => {
        ...
        if (test === 'shifter') {
            expect(ret).to.equal(expected.result);
        } else {
            expect(ret.result).to.equal(expected.result);
        }

        if (ret.n) {
            expect(ret.n).to.equal(expected.n);
        }
        if (ret.z) {
            expect(ret.z).to.equal(expected.z);
        }
    });
}
...
describe('MicAlu', () => {
    describe('Alu', () => {
        ...
        describe('passThrough leftOp', () => {
            ...
            testBlock('Passthrough test 1', bits, {
                a: '0000000000000000',
                b: '1111111111111111'
            }, {
                result: zero,
            ...
            testBlock('Passthrough test 2', bits, {
                a: '1111111111111111',
                b: '0000000000000000'
            }, {
